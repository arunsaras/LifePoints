      ...
      <StatusBar backgroundColor="#534AA2"/>
         ...
         <View style={{flexDirection:"row"}}>
                      ...
                      <TouchableOpacity onPress={()=>{setVisible(true)}} style={{justifyContent:"center",alignItems:"center"}}>
                            <Text style={{color:"#ffff",fontSize:6,fontFamily:"MuseoSans_500"}}>Points</Text>
                            <View style={{marginTop:10}}>
                            <Text style={{color:"#ffff",fontSize:12,fontFamily:"MuseoSans_500"}}>40</Text>
            ...
            <View style={{marginTop:19,paddingLeft:25}}>
                   ...
                   <Text style={{color:"#ffff",fontSize:12,fontFamily:"MuseoSans_700"}}>DIGITAL MEMBER CARD</Text>

            </View>
            <View style={{flex:1,justifyContent:"center",alignItems:"center"}}>
                <View style={{height:214,width:214,borderRadius:7,borderWidth:5,borderColor:"#A8A8A8",backgroundColor:"#ffff",justifyContent:"center",alignItems:"center"}}>
                <Image style={{height:190,width:190}} source={require('../assets/qr.png')}/>
                </View>
